...
const ProfilePage = (props) => {
    ...
    const top20Ids = props.creatorsdata && props.creatorsdata.slice(0, 20).map(creator => creator.id);
    const istopCreator = top20Ids.includes(user && user.id);
    const userRank = props.creatorsdata.findIndex(creator => creator.id === user?.id);
        ...
        <>
            <main className="hidebar dark:bg-[#212D3D] w-full relative flex min-h-screen flex-col items-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 py-5">
                        ...
                        {userRank < 2 ?
                            ...
                            <div className='flex items-center flex-col px-5 border-l py-4 justify-center'>
                                ...
                                <Link className='mt-2' href="/leaderboard">
                ...
                <div className='w-full mt-8'>
                    {(() => {
                        if (filters === 'created') {
                            return <Created uploadCheck={props.uploadCheck} allSoundsOfUser={allSoundsOfUser} setRefreshKey={setRefreshKey} />
