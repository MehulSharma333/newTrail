...
const Botbar = () => {
  ...
  return (
    <div class="flex flex-col py-8 pb-2 gap-5 items-center border-t-2 bg-[#F6F8FC] dark:bg-gray-900 px-5 xl:px-5 lg:px-10 md:px-20 sm:px-14 relative h-full w-full max-w-inner-content">
        ...
        <nav class="grid grid-cols-2 sm:grid-cols-4 gap-y-10 gap-x-12 py-2 my-2">
          <div class="flex flex-col col-span-2 justify-center">
            <div class="cursor-pointer">
              <Link href="/">
                <h6 className="font-bold dark:text-white text-center text-3xl md:text-4xl lg:text-5xl">SoundEffectButtons</h6>
              </Link>
            </div>
          ...
          <div class="flex flex-col">
            ...
            <ul className='dark:text-gray-200'>
              ...
              <li className="my-2 listBorder relative pb-2 w-fit">
                <Link href="/reaction-soundboard">
                {t("reaction_soundboard")}
                </Link>
              </li>
              <li className="my-2 listBorder relative pb-2 w-fit">
                <Link href="/discord-soundboard" className=" my-2 listBorder relative pb-2 w-fit">
          ...
          <div class="flex flex-col">
            ...
            <ul className='dark:text-gray-200'>
              ...
              <Link href={'/dcma-copyright-policy'}>
                <li class="my-2 listBorder relative pb-2 w-fit">
