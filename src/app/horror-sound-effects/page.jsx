...
const HorrorSoundEffects = async () => {

  const categorySounds = await getSoundsByCategory('horror_sound_effects');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Horror Sound Effects'} catUrl={'horror-sound-effects'} catValue={'horror_sound_effects'}
        title={'horror_title'}
