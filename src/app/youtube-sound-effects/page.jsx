...
const YoutubeSoundEffects = async () => {

  const categorySounds = await getSoundsByCategory('youtube_sound_effects');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Youtube Sound Effects'} catUrl={'youtube-sound-effects'} catValue={'youtube_sound_effects'}
        title={'youtube_title'}
