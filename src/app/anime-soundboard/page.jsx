...
const AnimeSoundboard = async () => {

  const categorySounds = await getSoundsByCategory('anime_soundboard');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Anime Soundboard'} catUrl={'anime-soundboard'} catValue={'anime_soundboard'}
        title={'anime_title'}
