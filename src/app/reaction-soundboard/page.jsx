...
const ReactionSoundboard = async () => {

  const categorySounds = await getSoundsByCategory('reaction_soundboard');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Reaction Soundboard'} catUrl={'reaction-soundboard'} catValue={'reaction_soundboard'}
