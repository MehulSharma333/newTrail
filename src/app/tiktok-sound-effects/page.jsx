...
const TiktokSoundEffects = async () => {

  const categorySounds = await getSoundsByCategory('tiktok_sound_effects');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Tiktok Sound Effects'} catUrl={'tiktok-sound-effects'} catValue={'tiktok_sound_effects'}
        title={'tiktok_title'}
