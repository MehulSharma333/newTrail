...
const Terms = () => {
  ...
  return (
    <>
      <head>
        <title>Terms of Use | SoundEffectButtons
        </title>
        <meta
          name="description"
          content=" Review the Terms of Use for SoundEffectButtons. Understand the rules and guidelines for using our sound effects and services."
        />
      </head>
      <div>
        ...
        <main className="hidebar text-gray-300 w-full dark:bg-[#212D3D] relative flex min-h-screen flex-col items-center">
          ...
          {/* title,description */}
          <div className="mt-[30px] text-gray-600 dark:text-gray-100 w-full flex flex-col items-center gap-6 py-16 px-5">
