...
const PrankSoundboard = async () => {

  const categorySounds = await getSoundsByCategory('prank_soundboard');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Prank Soundboard'} catUrl={'prank-soundboard'} catValue={'prank_soundboard'}
        title={'prank_title'}
