...
const AnimalSoundEffects = async () => {

  const categorySounds = await getSoundsByCategory('animal_sound_effects');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Animal Sound Effects'} catUrl={'animal-sound-effects'} catValue={'animal_sound_effects'}
        title={'animal_title'}
