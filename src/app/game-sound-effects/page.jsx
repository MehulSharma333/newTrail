...
const GameSoundEffects = async () => {

  const categorySounds = await getSoundsByCategory('game_sound_effects');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Game Sound Effects'} catUrl={'game-sound-effects'} catValue={'game_sound_effects'}
        title={'game_title'}
