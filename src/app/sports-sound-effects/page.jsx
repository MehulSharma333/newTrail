...
const SportsSoundEffects = async () => {

  const categorySounds = await getSoundsByCategory('sports_sound_effects');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Sports Sound Effects'} catUrl={'sports-sound-effects'} catValue={'sports_sound_effects'}
        title={'sports_title'}
