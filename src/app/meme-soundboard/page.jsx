...
const MemeSoundboard = async () => {

  const categorySounds = await getSoundsByCategory('meme_soundboard');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Meme Soundboard'} catUrl={'meme-soundboard'} catValue={'meme_soundboard'}
        title={'meme_title'}
