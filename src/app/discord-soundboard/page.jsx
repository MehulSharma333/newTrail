...
const DiscordSoundboard = async () => {

  const categorySounds = await getSoundsByCategory('discord_soundboard');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Discord Soundboard'} catUrl={'discord-soundboard'} catValue={'discord_soundboard'}
        title={'discord_title'}
