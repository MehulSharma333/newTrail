...
const FreeSoundEffects = async () => {

  const categorySounds = await getSoundsByCategory('free_sound_effects');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Free Sound Effects'} catUrl={'free-sound-effects'} catValue={'free_sound_effects'}
        title={'free_title'}
