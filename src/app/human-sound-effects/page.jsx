...
const HumanSoundEffects = async () => {

  const categorySounds = await getSoundsByCategory('human_sound_effects');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Human Sound Effects'} catUrl={'human-sound-effects'} catValue={'human_sound_effects'}
        title={'human_title'}
