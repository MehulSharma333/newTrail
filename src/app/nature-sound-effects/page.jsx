...
const NatureSoundEffects = async () => {

  const categorySounds = await getSoundsByCategory('nature_sound_effects');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Nature Sound Effects'} catUrl={'nature-sound-effects'} catValue={'nature_sound_effects'}
        title={'nature_title'}
