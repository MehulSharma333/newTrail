...
const MovieSoundEffects = async () => {

  const categorySounds = await getSoundsByCategory('movie_sound_effects');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Movie Sound Effects'} catUrl={'movie-sound-effects'} catValue={'movie_sound_effects'}
        title={'movie_title'}
