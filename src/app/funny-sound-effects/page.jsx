...
const FunnySoundEffects = async () => {

  const categorySounds = await getSoundsByCategory('funny_sound_effects');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Funny Sound Effects'} catUrl={'funny-sound-effects'} catValue={'funny_sound_effects'}
