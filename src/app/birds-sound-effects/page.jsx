...
const BirdsSoundEffects = async () => {

  const categorySounds = await getSoundsByCategory('birds_sound_effects');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Birds Sound Effects'} catUrl={'birds-sound-effects'} catValue={'birds_sound_effects'}
        title={'birds_title'}
