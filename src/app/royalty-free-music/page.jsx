...
const RoyaltyFreeMusic = async () => {

  const categorySounds = await getSoundsByCategory('royalty_free_music');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Royalty Free Music'} catUrl={'royalty-free-music'} catValue={'royalty_free_music'}
