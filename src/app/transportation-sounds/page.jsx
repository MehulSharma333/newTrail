...
const TransportationSound = async () => {

  const categorySounds = await getSoundsByCategory('transportation_sounds');
  ...
  return (
    <>
      ...
      <Catalog categorySounds={categorySounds} catAlias={'Transportation Sound'} catUrl={'transportation-sounds'} catValue={'transportation_sounds'}
